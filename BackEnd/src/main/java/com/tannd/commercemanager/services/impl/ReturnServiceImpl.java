...
import com.tannd.commercemanager.repository.ReturnRepository;
...
@Service
@ServiceHelper
public class ReturnServiceImpl extends
        AbstractServiceImpl<ReturnRepository, ReturnMapper, ReturnDTO, Return>
        implements ReturnService {

    @Autowired
    ReturnRepository thisRepository;
    ...
    @Override
    public ReturnRepository getRepository() {
        initRepository();
        return repository;
    }
